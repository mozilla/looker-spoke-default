...
explore: dev_desktop_usage  {
  ...
  query: total_returned_second_day_last_full_month {
    dimensions: [dev_desktop_usage.normalized_country_code_subset]
    measures: [dev_desktop_usage.returned_second_day]
    filters: [
      dev_desktop_usage.analysis_period: "56 days ago for 28 days",
      dev_desktop_usage.year_over_year: "No",
      dev_desktop_usage.join_field: "yes"
    ]
    label: "Total new Firefox installs who returned for second day in last full month"
  }

  query: total_wk4_retained_last_full_month {
    dimensions: [dev_desktop_usage.normalized_country_code_subset]
    ...
    label:  "Total new Firefox installs who week 4 retained in last full month"
  }
}
