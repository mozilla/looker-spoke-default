view: mobile_fenix_funnel {
  derived_table: {
    sql: with play_store_retained as (
          ...
          FROM
          `moz-fx-data-marketing-prod.google_play_store.Retained_installers_play_country_v1`
          WHERE Package_name IN ('org.mozilla.firefox_beta')
          GROUP BY 1, 2, 3
      ),
