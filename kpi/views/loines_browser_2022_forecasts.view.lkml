view: loines_browser_2022_forecasts {
  ...
  measure: lower_target_pace {
    type: sum
    sql: CASE WHEN platform = 'desktop' THEN ${TABLE}.yhat  * 0.959120747 ELSE ${TABLE}.yhat * 0.912746182 END;;
    label: "Low-End Target Daily Pace"
  }

  measure: baseline_target_pace {
    type: sum
    sql: CASE WHEN platform = 'desktop' THEN ${TABLE}.yhat * 0.990897496 ELSE ${TABLE}.yhat * 0.980045439 END;;
    label: "Baseline Target Daily Pace"
  }

  measure: stretch_target_pace {
    type: sum
    sql: CASE WHEN platform = 'desktop' THEN ${TABLE}.yhat * 1.006562090 ELSE ${TABLE}.yhat * 1.066272613 END;;
