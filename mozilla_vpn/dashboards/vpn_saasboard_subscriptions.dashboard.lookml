- dashboard: vpn_saasboard_subscriptions
  ...
  - name: " (2)"
    type: text
    title_text: ''
    body_text: "This dashboard captures the current state and monthly trend of active\
      \ and new subscriptions.\n\n* Active subscriptions are paid subscriptions at\
      \ a moment in time.  \n\n* New subscriptions are subscriptions that started\
      \ at a particular date.\n\n`If you have any questions, please contact @wichan\
  ...
  - title: Current Active Subscriptions (by Country)
    ...
    fields: [subscriptions.count, subscriptions.country_name, subscriptions__active.active_date]
    pivots: [subscriptions.country_name]
    fill_fields: [subscriptions__active.active_date]
    sorts: [subscriptions__active.active_date desc, subscriptions.count desc 0, subscriptions.country_name
        desc]
    limit: 1
    column_limit: 50
  ...
  - title: Current Active Subscriptions (by Plan)
    ...
    explore: subscriptions
    type: looker_donut_multiples
    fields: [subscriptions.count, subscriptions.pricing_plan, subscriptions__active.active_date]
    pivots: [subscriptions.pricing_plan]
    fill_fields: [subscriptions__active.active_date]
    sorts: [subscriptions.pricing_plan, subscriptions__active.active_date desc]
    limit: 1
    column_limit: 50
    show_value_labels: true
    font_size: 12
  ...
  - title: Current Active Subscriptions (by Provider)
    ...
    explore: subscriptions
    type: looker_donut_multiples
    fields: [subscriptions.count, subscriptions__active.active_date, subscriptions.provider]
    pivots: [subscriptions.provider]
    fill_fields: [subscriptions__active.active_date]
    sorts: [subscriptions__active.active_date desc, subscriptions.count desc 0, subscriptions.provider
        desc]
    limit: 1
    column_limit: 50
    show_value_labels: true
