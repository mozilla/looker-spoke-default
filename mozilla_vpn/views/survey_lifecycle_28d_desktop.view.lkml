...
view: survey_lifecycle_28d_desktop__survey_data {
  drill_fields: [id]
  ...
  dimension: survey_lifecycle_28d_desktop__survey_data {
    type: string
    hidden: yes
    sql: survey_lifecycle_28d_desktop__survey_data ;;
  }
...
view: survey_lifecycle_28d_desktop__survey_data__options {
  drill_fields: [id]
