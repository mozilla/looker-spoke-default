view: relay_subscriptions_looker_hub {
  # This view file is created for a temporary use for relay SaaSboard MVP.
  #This acts like the subscriptions.view in looker-hub that is used for VPN SaaSboard.
