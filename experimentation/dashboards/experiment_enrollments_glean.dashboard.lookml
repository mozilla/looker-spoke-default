---
- dashboard: experiment_enrollments_glean
  title: Experiment Enrollments (Glean)
  layout: newspaper
  ...
  - title: Daily Active Population by Branch
    ...
    type: looker_line
    fields: [experiment_enrollment_daily_active_population_v2.branch, experiment_enrollment_daily_active_population_v2.time_time,
      experiment_enrollment_daily_active_population_v2.Total]
    pivots: [experiment_enrollment_daily_active_population_v2.branch]
    filters: {}
    sorts: [experiment_enrollment_daily_active_population_v2.time_time desc, experiment_enrollment_daily_active_population_v2.branch]
    limit: 500
    column_limit: 5000
    ...
    y_axes: [{label: Total, orientation: left, series: [{axisId: experiment_enrollment_daily_active_population_v2.Total,
            id: control - experiment_enrollment_daily_active_population_v2.Total, name: control}],
    ...
    listen:
      Time Range [UTC]: experiment_enrollment_daily_active_population_v2.time_time
      Experiment: experiment_enrollment_daily_active_population_v2.experiment
    row: 10
    col: 12
    width: 12
    height: 8
  - title: Daily Active Population
    ...
    explore: experiment_enrollment_daily_active_population_v2
    type: looker_line
    fields: [experiment_enrollment_daily_active_population_v2.Total, experiment_enrollment_daily_active_population_v2.time_time]
    filters: {}
    sorts: [experiment_enrollment_daily_active_population_v2.time_time desc]
    limit: 5000
    column_limit: 50
    x_axis_gridlines: false
    y_axis_gridlines: true
  ...
  - title: Cumulative Population Estimate
    ...
    type: looker_line
    fields: [experiment_enrollment_cumulative_population_estimate_v2.Total, experiment_enrollment_cumulative_population_estimate_v2.time_time]
    filters: {}
    sorts: [experiment_enrollment_cumulative_population_estimate_v2.time_time desc]
    limit: 5000
    column_limit: 50
    x_axis_gridlines: false
    y_axis_gridlines: true
    ...
    listen:
      Time Range [UTC]: experiment_enrollment_cumulative_population_estimate_v2.timeframe
      Experiment: experiment_enrollment_cumulative_population_estimate_v2.experiment
    row: 18
    col: 0
    width: 12
    height: 7
  - title: Cumulative Population Estimate by Branch
    ...
    explore: experiment_enrollment_cumulative_population_estimate_v2
    type: looker_line
    fields: [experiment_enrollment_cumulative_population_estimate_v2.time_time, experiment_enrollment_cumulative_population_estimate_v2.branch,
      experiment_enrollment_cumulative_population_estimate_v2.Total]
    pivots: [experiment_enrollment_cumulative_population_estimate_v2.branch]
    filters: {}
    sorts: [experiment_enrollment_cumulative_population_estimate_v2.time_time desc, experiment_enrollment_cumulative_population_estimate_v2.branch]
    limit: 5000
    column_limit: 50
    x_axis_gridlines: false
    y_axis_gridlines: true
    ...
    show_null_points: false
    interpolation: linear
    y_axes: [{label: Total, orientation: left, series: [{axisId: experiment_enrollment_cumulative_population_estimate_v2.Total,
            id: control - experiment_enrollment_cumulative_population_estimate_v2.Total,
            name: control}, {axisId: experiment_enrollment_cumulative_population_estimate_v2.Total,
            id: treatment-admarketplace - experiment_enrollment_cumulative_population_estimate_v2.Total,
  ...
  - title: Unenrollment Overall
    ...
    type: looker_column
    fields: [experiment_unenrollment_overall_v2.timestamp, experiment_unenrollment_overall_v2.Total]
    filters: {}
    sorts: [experiment_unenrollment_overall_v2.timestamp desc]
    limit: 5000
    column_limit: 50
    x_axis_gridlines: false
    y_axis_gridlines: true
    ...
    note_text: Updated every 10 minutes
    listen:
      Time Range [UTC]: experiment_unenrollment_overall_v2.timeframe
      Experiment: experiment_unenrollment_overall_v2.experiment
    row: 39
    col: 0
    width: 12
    height: 7
  - title: Unenrollment Overall by Branch
    ...
    type: looker_line
    fields: [experiment_unenrollment_overall_v2.timestamp, experiment_unenrollment_overall_v2.Total,
      experiment_unenrollment_overall_v2.branch]
    pivots: [experiment_unenrollment_overall_v2.branch]
    filters: {}
    sorts: [experiment_unenrollment_overall_v2.timestamp desc, experiment_unenrollment_overall_v2.branch]
    limit: 5000
    column_limit: 50
    x_axis_gridlines: false
    y_axis_gridlines: true
    ...
    show_null_points: true
    interpolation: step
    y_axes: [{label: Total, orientation: left, series: [{axisId: control - experiment_unenrollment_overall_v2.Total,
            id: control - experiment_unenrollment_overall_v2.Total, name: control}, {
            axisId: treatment-admarketplace-12 - experiment_unenrollment_overall_v2.Total,
            id: treatment-admarketplace-12 - experiment_unenrollment_overall_v2.Total,
            name: treatment-admarketplace-12}, {axisId: treatment-admarketplace-78
              - experiment_unenrollment_overall_v2.Total, id: treatment-admarketplace-78
              - experiment_unenrollment_overall_v2.Total, name: treatment-admarketplace-78}],
        showLabels: true, showValues: true, unpinAxis: false, tickDensity: default,
        tickDensityCustom: 5, type: linear}]
    x_axis_label: Time [UTC]
    ordering: none
  ...
  - title: Enrollment Overall
    ...
    type: looker_column
    fields: [experiment_enrollment_overall_v2.timestamp, experiment_enrollment_overall_v2.Total]
    filters: {}
    sorts: [experiment_enrollment_overall_v2.timestamp desc]
    limit: 5000
    column_limit: 50
    x_axis_gridlines: false
    y_axis_gridlines: true
    ...
    show_silhouette: false
    totals_color: "#808080"
    y_axes: [{label: Total, orientation: left, series: [{axisId: experiment_enrollment_overall_v2.Total,
            id: experiment_enrollment_overall_v2.Total, name: Total}], showLabels: true,
    ...
    note_text: Updated every 10 minutes
    listen:
      Time Range [UTC]: experiment_enrollment_overall_v2.timeframe
      Experiment: experiment_enrollment_overall_v2.experiment
    row: 32
    col: 0
    width: 12
    height: 7
  - title: Enrollment Overall by Branch
    ...
    type: looker_line
    fields: [experiment_enrollment_overall_v2.timestamp, experiment_enrollment_overall_v2.Total,
      experiment_enrollment_overall_v2.branch]
    pivots: [experiment_enrollment_overall_v2.branch]
    filters: {}
    sorts: [experiment_enrollment_overall_v2.timestamp desc, experiment_enrollment_overall_v2.branch]
    limit: 5000
    column_limit: 50
    x_axis_gridlines: false
    y_axis_gridlines: true
    ...
    y_axes: [{label: Total, orientation: left, series: [{axisId: experiment_enrollment_overall_v2.Total,
        ...
        type: linear}]
    x_axis_label: Time [UTC]
    hidden_series: [fission-disabled - experiment_enrollment_overall_v2.Total]
    ordering: none
    show_null_labels: false
    show_totals_labels: false
    show_silhouette: false
  ...
  - title: 'Other Events Overall '
    ...
    type: looker_column
    fields: [experiment_enrollment_other_events_overall_v2.Total, experiment_enrollment_other_events_overall_v2.timestamp,
      experiment_enrollment_other_events_overall_v2.event]
    pivots: [experiment_enrollment_other_events_overall_v2.event]
    filters: {}
    sorts: [experiment_enrollment_other_events_overall_v2.timestamp desc, experiment_enrollment_other_events_overall_v2.event]
    x_axis_gridlines: false
    y_axis_gridlines: true
    show_view_names: false
    show_y_axis_labels: true
    ...
    note_text: Updated every 10 minutes
    listen:
      Time Range [UTC]: experiment_enrollment_other_events_overall_v2.timeframe
      Experiment: experiment_enrollment_other_events_overall_v2.experiment
    row: 46
    col: 0
    width: 12
    height: 7
  - title: Other Events Overall by Branch
    ...
    pivots: [branch_event]
    filters: {}
    sorts: [experiment_enrollment_other_events_overall_v2.timestamp desc, branch_event]
    dynamic_fields:
    - category: dimension
      expression: concat(${experiment_enrollment_other_events_overall_v2.branch}," -
        ", ${experiment_enrollment_other_events_overall_v2.event})
      label: Branch + Event
      value_format:
      value_format_name:
  ...
  - title: Enrollment Status
    ...
    type: single_value
    fields: [enrollment_status_glean.message, enrollment_status_glean.experiment]
    sorts: [enrollment_status_glean.message]
    limit: 1
    ...
    conditional_formatting_include_totals: false
    conditional_formatting_include_nulls: false
    hidden_fields: [enrollment_status_glean.experiment]
    x_axis_gridlines: false
    y_axis_gridlines: true
    show_view_names: false
    show_y_axis_labels: true
    ...
    y_axes: []
    listen:
      Experiment: enrollment_status_glean.experiment
    row: 0
    col: 0
    width: 24
    height: 2
  - title: New Tile
    ...
    type: single_value
    fields: [sample_ratio_mismatch_glean.message, sample_ratio_mismatch_glean.p_value]
    filters:
      sample_ratio_mismatch_glean.metric: enrollments
    sorts: [sample_ratio_mismatch_glean.message]
    limit: 500
    custom_color_enabled: true
    show_single_value_title: true
    ...
    y_axes: []
    listen:
      Experiment: sample_ratio_mismatch_glean.experiment
    row: 2
    col: 0
    width: 8
    height: 2
  - title: New Tile
    ...
    fields: [sample_ratio_mismatch_glean.message, sample_ratio_mismatch_glean.p_value]
    filters:
      sample_ratio_mismatch_glean.metric: unenrollments
    sorts: [sample_ratio_mismatch_glean.message]
    limit: 500
    custom_color_enabled: true
    show_single_value_title: true
  ...
  - title: New Tile
    ...
    fields: [sample_ratio_mismatch_glean.message, sample_ratio_mismatch_glean.p_value]
    filters:
      sample_ratio_mismatch_glean.metric: daily^_active^_clients
    sorts: [sample_ratio_mismatch_glean.message]
    limit: 500
    custom_color_enabled: true
    show_single_value_title: true
  ...
  - title: Daily Enrollments by Branch
    ...
    explore: experiment_enrollment_overall_v2
    type: looker_line
    fields: [experiment_enrollment_overall_v2.Total, experiment_enrollment_overall_v2.branch,
      experiment_enrollment_overall_v2.time_date]
    pivots: [experiment_enrollment_overall_v2.branch]
    fill_fields: [experiment_enrollment_overall_v2.time_date]
    filters: {}
    sorts: [experiment_enrollment_overall_v2.branch, experiment_enrollment_overall_v2.time_date
        desc]
    limit: 5000
    column_limit: 50
    x_axis_gridlines: false
  ...
  - name: Experiment
    ...
    explore: experiment_enrollment_daily_active_population_v2
    listens_to_filters: []
    field: experiment_enrollment_daily_active_population_v2.experiment
  - name: Time Range [UTC]
    ...
    explore: experiment_enrollment_daily_active_population_v2
    listens_to_filters: []
    field: experiment_enrollment_daily_active_population_v2.time_date
